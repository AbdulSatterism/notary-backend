...
const resendOTP = (values: ICreateAccount) => {
  const data = {
    to: values.email,
    subject: 'Resend OTP',
    html: `<body style="font-family: Arial, sans-serif; background-color: #f5f7fa; margin: 0; padding: 20px; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #fff; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.08); overflow: hidden;">
        ...
        <div style="background-color: #0F52BA; padding: 25px 30px; text-align: center;">
            <h1 style="color: #fff; font-size: 28px; margin: 0; letter-spacing: 1px;">NOTARY</h1>
            <p style="color: rgba(255,255,255,0.9); font-size: 16px; margin: 8px 0 0;">New Verification Code</p>
        </div>
        
        <!-- Content Section -->
        <div style="padding: 35px 40px;">
            <h2 style="color: #0F52BA; font-size: 24px; margin-top: 0; margin-bottom: 20px;">Your New Verification Code</h2>
            
            <p style="color: #555; font-size: 16px; line-height: 1.6; margin-bottom: 20px;">
                Hi ${values.name}, we've generated a new verification code for your NOTARY account. Please use the following one-time passcode:
            </p>
            ...
            <p style="color: #777; font-size: 15px; line-height: 1.6; text-align: center; margin-bottom: 30px;">
                This new verification code will expire in <strong style="color: #0F52BA;">20 minutes</strong>.
            </p>
            
            <!-- Additional Information -->
            <div style="background-color: #f9fafc; padding: 20px; border-radius: 8px; border-left: 4px solid #0F52BA;">
                <p style="color: #666; font-size: 14px; line-height: 1.6; margin: 0;">
                    <strong>Note:</strong> For security reasons, each verification code can only be used once. 
                    If you didn't request this new code, please contact our support team immediately.
                </p>
            </div>
        </div>
